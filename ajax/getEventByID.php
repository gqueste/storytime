...
$query = "select events.event_id id, events.name name, events.description description, events.event_date date, events.location_id location_id, parent.event_id parent_id, parent.name parent_name, elements.element_id, projects.project_id, projects.name project_name ";
$query .= "from events ";
